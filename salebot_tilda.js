if (SalebotTildaIntegration == undefined) {
    ...
    var countries = {
        ...
        "86": ["China (中国)", "cn", "86", '132-37648956', [3, 8], false],
        ...
        "49": ["Germany (Deutschland)", "de", "49", '176-64348956', [3, 8], false],
        ...
        "62": ["Indonesia", "id", "62", '153-37648956', [3, 8], false],
        ...
        "212": ["Morocco (‫المغرب‬‎)", "ma", "212", "649-999995", [3, 6], false],
        ...
        "82": ["South Korea (대한민국)", "kr", "82", "010-3456-7859", [3, 4, 4], false],
    ...
    function createHref(className, askPhone, askEmail, askName, name_important, askFbCookie, askGaCookie, askYmCookie, askRsCookie, askFbcCookie, validatePhone, validateEmail, askComagicCookie, askIpAddr, askUserAgent) {
        ...
        var mainHref = $("." + className).attr("href")
        ...
        el.find(".ml_quiz").each(function(){
            ...
            let important = quiz_element.find(".ml_quiz_important").text() === "true"
    ...
    function mini_landing_init(askFbCookie, askGaCookie, askYmCookie, askRsCookie, askFbcCookie, askComagicCookie) {
        ...
        $(".ml_quiz_total_answer").on("click", function(){
            if ($(this).parent().find(".ml_quiz_answers").css('display') === "none") {
                $(this).parent().find(".ml_quiz_answers").show()
            } else {
                $(this).parent().find(".ml_quiz_answers").hide()
            }
        })
        $(".ml_quiz_answer").off("click")
        $(".ml_quiz_answer").on("click", function(){
            $(this).parents(".ml_quiz_answers_container").find(".ml_quiz_total_answer").text($(this).text())
        })
